...
```
Error: page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at http://www.makemytrip.com/
Call log:
  - navigating to "http://www.makemytrip.com/", waiting until "domcontentloaded"
...
```ts
  ...
  4  | 
  5  |     // Navigate to MMT
> 6  |     await page.goto("http://www.makemytrip.com/", {
     |                ^ Error: page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at http://www.makemytrip.com/
