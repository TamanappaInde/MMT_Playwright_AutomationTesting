...
Locator: locator('//label[@for=\'fromCity\']')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('//label[@for=\'fromCity\']')
...
- main:
  - main:
    ...
    - list: ITC Hotels Limited Sterling Hotels & Resorts CGH Earth Experience Hotels Cinnamon Hotels
    - button "Previous"
    ...
    - paragraph: Use code WELCOMEMMT and get FLAT 25% OFF* on your first Hotel booking
    - paragraph:
      - img
      - text: +91 —
